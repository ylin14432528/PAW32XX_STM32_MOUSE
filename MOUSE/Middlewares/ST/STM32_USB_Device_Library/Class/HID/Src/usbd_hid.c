...
__ALIGN_BEGIN static uint8_t USBD_HID_CfgFSDesc[USB_HID_CONFIG_DESC_SIZ]  __ALIGN_END =
{
  ...
  HID_KEYBOARDMOUSE_REPORT_DESC_SIZE,/*wItemLength: Total length of Report descriptor*/
  0x00,
...
//  0x29,   0x05,  // USAGE_MAXIMUM (Button 5) - 修改为5个按钮
//  0x15,   0x00,  // LOGICAL_MINIMUM (0)
//  0x25,   0x01,  // LOGICAL_MAXIMUM (1)
//  0x95,   0x05,  // REPORT_COUNT (5) - 修改为5个按钮
//  0x75,   0x01,  // REPORT_SIZE (1) 
//  0x81,   0x02,  // INPUT (Data,Var,Abs)
//  0x95,   0x01,  // REPORT_COUNT (1)
//  0x75,   0x03,  // REPORT_SIZE (3) - 修改为3位填充（总共8位）
...
__ALIGN_BEGIN static uint8_t HID_KEYBOARDMOUSE_ReportDesc[HID_KEYBOARDMOUSE_REPORT_DESC_SIZE]  __ALIGN_END =
{
